  ...
  return (
    ...
    >
      ...
      <div className="blob-outer absolute inset-0">
        <div className="floating-blob absolute left-[5%] top-[10%] h-[800px] w-[800px] rounded-full bg-gradient-to-br from-[#39FF14]/8 to-transparent blur-[180px]" />
        <div className="floating-blob absolute right-[0%] top-[40%] h-[900px] w-[900px] rounded-full bg-gradient-to-bl from-[#39FF14]/6 to-transparent blur-[200px]" />
        <div className="floating-blob absolute left-[30%] top-[70%] h-[700px] w-[700px] rounded-full bg-gradient-to-tr from-[#32CD32]/7 to-transparent blur-[160px]" />
      </div>
      
      <div className="blob-outer absolute inset-0">
        <div className="wave absolute right-[15%] top-[15%] h-[500px] w-[600px] rounded-full bg-gradient-to-br from-[#39FF14]/5 to-transparent blur-[140px]" />
        <div className="wave absolute left-[5%] bottom-[20%] h-[550px] w-[650px] rounded-full bg-gradient-to-tr from-[#98FB98]/4 to-transparent blur-[150px]" />
        <div className="wave absolute right-[40%] bottom-[35%] h-[400px] w-[450px] rounded-full bg-gradient-to-bl from-[#00FF00]/4 to-transparent blur-[100px]" />
      </div>
      
      <div className="blob-outer absolute inset-0">
        <div className="floating-blob absolute left-[50%] top-[25%] h-[300px] w-[350px] rounded-full bg-gradient-to-br from-[#39FF14]/6 to-transparent blur-[80px]" />
        <div className="floating-blob absolute right-[50%] bottom-[15%] h-[280px] w-[320px] rounded-full bg-gradient-to-tl from-[#90EE90]/5 to-transparent blur-[75px]" />
        <div className="floating-blob absolute left-[10%] top-[60%] h-[250px] w-[300px] rounded-full bg-gradient-to-br from-[#228B22]/4 to-transparent blur-[70px]" />
        <div className="floating-blob absolute right-[10%] top-[80%] h-[200px] w-[250px] rounded-full bg-gradient-to-bl from-[#39FF14]/5 to-transparent blur-[60px]" />
      </div>

      <div className="blob-outer absolute inset-0">
        <div className="glow orb absolute left-[20%] top-[30%] h-[150px] w-[180px] rounded-full bg-[#39FF14]/8 blur-[50px]" />
        <div className="glow orb absolute right-[25%] top-[50%] h-[120px] w-[150px] rounded-full bg-[#98FB98]/6 blur-[40px]" />
        <div className="glow orb absolute left-[60%] bottom-[25%] h-[100px] w-[130px] rounded-full bg-[#32CD32]/7 blur-[35px]" />
        <div className="glow orb absolute right-[70%] top-[20%] h-[80px] w-[100px] rounded-full bg-[#39FF14]/5 blur-[30px]" />
      </div>
      ...
      <div className="blob-outer absolute inset-0">
        <div className="flow-line absolute left-[8%] top-[45%] h-[1px] w-[300px] bg-gradient-to-r from-transparent via-[#39FF14]/15 to-transparent" />
        <div className="flow-line absolute left-[25%] top-[60%] h-[1px] w-[400px] bg-gradient-to-r from-transparent via-[#39FF14]/10 to-transparent" />
        <div className="flow-line absolute left-[55%] top-[35%] h-[1px] w-[350px] bg-gradient-to-r from-transparent via-[#39FF14]/12 to-transparent" />
        <div className="flow-line absolute left-[70%] top-[75%] h-[1px] w-[250px] bg-gradient-to-r from-transparent via-[#39FF14]/8 to-transparent" />
      </div>
